...
# 数据集和场景定义
declare -A datasets
#datasets[mipnerf360]="bicycle bonsai counter flowers garden kitchen room stump treehill"
datasets[mipnerf360]="bicycle bonsai counter garden kitchen room stump"
...
# CUDA_VISIBLE_DEVICES=3 LD_LIBRARY_PATH=foobar python ~/CV/3DGS/Topology-GS/metrics.py --cfg ~/CV/3DGS/Topology-GS/experiments/topology/nerfsynthetic/chair/baseline_aug.yaml --spath ../data/nerfsynthetic/chair --opath ../output/nerfsynthetic/baseline_aug/chair
